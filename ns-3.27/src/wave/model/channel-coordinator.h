...
public:
  ...
  /**
    * \return the default request message interval for multi-channel operation (50 milliseconds).
    */
   static Time GetDefaultRMInterval (void);
   /**
     * \return the default calculate demand queue interval for multi-channel operation (50 milliseconds).
     */
    static Time GetDefaultCDQInterval (void);
    /**
      * \return the default ACK message interval for multi-channel operation (50 milliseconds).
      */
     static Time GetDefaultAMInterval (void);
  /**
  ...
  /**
   * \param duration the future time after duration
   * \returns whether future time is in RM Interval
   */
  bool IsRMInterval (Time duration = Seconds (0.0)) const;
  /**
   * \param duration the future time after duration
   * \returns whether future time is in CDQ Interval
   */
  bool IsCDQInterval (Time duration = Seconds (0.0)) const;
  /**
   * \param duration the future time after duration
   * \returns whether future time is in AM Interval
   */
  bool IsAMInterval (Time duration = Seconds (0.0)) const;
  /**
   * \param duration the future time after duration
...
private:
  ...
  Time m_rm;//RMIntervel all of the nodes broadcast Request Message
  Time m_cdq;//CDQIntervel cluster head calculates the demand queue
  Time m_am;//AMIntervel member nodes back the ACK message
